...
<p><a href="commenter-<?php echo $news['id'];?>.php">Ajouter un commentaire</a></p>
...
<fieldset>
	<legend>Posté par <strong><?php echo htmlspecialchars($comment['auteur'];)?></strong> le <?php echo $comment['date']->format('d/m/Y H\i'); ?>
	<?php  if($user->isAuthenticated()){?>
		<a href="admin/comment-update-<?php echo $comment['id']; ?>.php">Modifier</a>
		<a href="admin/comment-delete-<?php echo $comment['id']; ?>.php">Supprimer</a>
	<?php } ?>
	</legend>
